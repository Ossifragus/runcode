...
qn <- 0.25
res <- QREM_vs("tmp/sim05.RData", 1, 2:501, qn=qn)
...
library(xtable)
print(xtable(ests, digits=3), file="tmp/SimA4_5.tex")

qrdg <- QRdiagnostics(dfsemms[,2], "X1",qremFit$ui, qn, filename="tmp/simVS5.pdf")
