...
% This file requires --shell-escape (for \write18 calls that create the
% generated/ directory tree). Without it, pdflatex silently skips all
% \write18 commands and then fails with "I can't write on file ...".
% The magic comment above makes AUCTeX (Emacs) pass --shell-escape
% automatically. Command-line users: pdflatex --shell-escape ChunkTest.tex
%
...
%      without creating the intermediate directory. Fixed by using
%      Python os.makedirs for cross-platform directory creation.
